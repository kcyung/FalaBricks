...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div style="padding: 30px;">
        <div class="PostContainer" style="margin: 0 auto;">
            ...
            <asp:Label ID="Label1" runat="server" Text="blah blah blah blah" CssClass="PostTitle"></asp:Label>
            <asp:Button ID="Button1" runat="server" Text="upvote" CssClass="PostUpvote" />
            <asp:Button ID="Button2" runat="server" Text="downvote" CssClass="PostDownVote" />
